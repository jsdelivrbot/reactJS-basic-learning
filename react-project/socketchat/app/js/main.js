	...
	var App = (function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				if (this.state.user == '') {
					return _react2['default'].createElement(_UsersUserFormJsx2['default'], { edit: this.emit.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageJsx = __webpack_require__(205);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'form',
						{ onSubmit: this.onSubmit.bind(this) },
						_react2['default'].createElement('input', { type: 'text', className: 'form-control', placeholder: 'input your username',
							ref: 'name'
						})
					)
				);
